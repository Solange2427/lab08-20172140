<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%  User mio = (User) request.getAttribute("UserObj"); %>
        ...
        <div class="container">
    		<form method="get" action="/users/edit">
    			<div class="form-group">
					...
					<input class="form-control" name="lok" type="text" value="<%= mio.getUserid() %>" >
				</div>
        		<div class="form-group">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                    	<input class="form-control" name="email" type="email" value="<%= mio.getEmail() %>" >
                    </div>
                </div>
                <div class="form-group row">
                	<label for="cumple" class="col-2 col-form-label">Cumpleaños:</label>
                    <div class="col-10">
                    <input class="form-control" name="cumple" type="date" value="<%= mio.getBirth() %>" >
                    </div>
                </div>

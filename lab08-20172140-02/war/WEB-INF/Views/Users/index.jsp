...
<body>
    ...
    <section class="jumbotron">
     ...
     <section class="main container">
        ...
        <table class= table>
        <tr>
        	<th style="background:#C0FCD1"> ACTIONS: <br> <a href="/users/add">New Users </a> </th>
        </tr>
        <tr>
        	<th>
    			<%if(users.size() >= 0){ %>
    		<table class="table">
    			...
    			<%for(int i = 0 ; i < users.size();i++){ %>
    				<% User d = (User)users.get(i); %>
    				<tr>
    					<td><a href="/users/view?id=<%= (Long) d.getId() %>"><%= (Long) d.getId()%></a> </td>
    					<td><%= d.getEmail() %> </td>
    					<td><%= (Long) d.getRoleid() %> </td>
    					<td><%= d.getBirth() %> </td>
    					<td><%= d.getGender() %> </td>
    					<td><%= d.isStatus() %> </td>
    					<td> 
    						<a href="/users/delete?id=<%= (Long)d.getId() %>"> Delete </a>
    					</td>
    				</tr>
    			<%} %>
    		</table>

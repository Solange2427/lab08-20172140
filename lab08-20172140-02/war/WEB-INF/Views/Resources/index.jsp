<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% List<Resource> resor = (List<Resource>)request.getAttribute("resor"); %>
...
<body>
    ...
    <section class="jumbotron">
     ...
     <section class="main container">
        ...
        <table class= table>
        <tr>
        	<th style="background:#C0FCD1"> ACTIONS: <br> <a href="/resources/add">New Resource </a> </th>
        </tr>
        <tr>
        	<th>
    		<%if(resor.size() >= 0){ %>
    		<table class="table">
    			...
    			<%for(int i = 0 ; i < resor.size();i++){ %>
    				<% Resource b = (Resource)resor.get(i); %>
    				<tr>
    					<td><a href="/resources/view?id=<%= b.getId() %>"><%= b.getId() %></a>  </td>
    					<td><%= b.getNombre() %> </td>
    					<td><%= b.isStatus() %> </td>
    					<td> 
    						<a href="/resources/delete?id=<%= b.getId()%>"> Delete </a> 
    					</td>
    				</tr>
    			<%} %>
    		</table>

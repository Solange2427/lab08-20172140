<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% Resource mio = (Resource) request.getAttribute("ResoObj");%>
...
<body>
    ...
    <section class="jumbotron">
     ...
     <section class="main container">
        ...
        <table class= table>
        <tr>
        	<th style="background:#C0FCD1"> ACTIONS: <br> <a href="/resources/index">List Resources </a> </th>
        </tr>
        <tr>
        	<th>
        		...
        		<div class="form-group">
            		<label for="nombre">Nombre:</label>
              		<input class="form-control" name="nombre" type="text" value="<%= mio.getNombre() %>" > 
            	</div>
